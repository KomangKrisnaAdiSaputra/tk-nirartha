...
@section('data')
    ...
    <div class="col-lg-6 col-md-12 mx-auto">
        <div class="account-setting">
            <h6>Edit Pendaftaran Awal</h6>
            <form action="{{ route('orangTua.updatePendaftaranSiswa', $data['pendaftaran']['id_siswa']) }}" method="POST"
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="catatan_pendaftaran_awal" name="catatan_pendaftaran_awal" cols="20"
                            rows="5" placeholder="Catatan Pendaftaran Awal" readonly>{{ $data['pendaftaran']['catatan_pendaftaran_awal'] }}</textarea>
                    </div>
                </div>
